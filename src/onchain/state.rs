...
pub async fn get_on_chain_hash(
    rpc: &RpcClient,
    program_id: &crate::types::Address,
) -> Result<String> {
...
mod tests {
    ...
    async fn test_get_on_chain_hash() {
        let program_id =
            crate::types::Address::from_str("verifycLy8mB96wd9wqq3WDXQwM4oU6r42Th37Db9fC").unwrap();
    ...
    async fn test_get_on_chain_hash_closed_program() {
        let program_id =
            crate::types::Address::from_str("2gFsaXeN9jngaKbQvZsLwxqfUrT2n4WRMraMpeL8NwZM")
                .unwrap();
